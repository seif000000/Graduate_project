...
const Home = () => {
  ...
  const stats = [
    ...
    { label: 'طلب استغاثة نشط', value: '0', icon: '🚨', color: 'text-red-600', bg: 'bg-red-50', change: 'ساعد في إنقاذ حياة' },
    { label: 'حالة استفادت مجاناً', value: '0', icon: '❤️', color: 'text-blue-600', bg: 'bg-blue-50', change: 'كل مساعدة تفرق' },
  ];
      ...
      <section className="relative overflow-hidden rounded-[2.5rem] bg-primary-950 p-12 text-white shadow-2xl">
        <div className="relative z-10 max-w-2xl space-y-6 text-right">
          ...
          >
            ...
            <span className="text-xs font-black uppercase tracking-widest text-emerald-400">منصة إنسانية لتبادل الأدوية</span>
          </motion.div>
          ...
          >
            شارك الدواء الزيادة <br />
            <span className="bg-gradient-to-r from-primary-300 to-primary-500 bg-clip-text text-transparent">وأنقذ حياة إنسان 💚</span>
          </motion.h1>
          ...
          >
            مُسند بتوصّل الأدوية الفائضة اللي عندك للمريض اللي محتاجها — مجاناً أو بسعر رمزي، قريب منك وبكل سهولة.
          </motion.p>
        ...
        <section className="lg:col-span-2">
          <div className="glass-card overflow-hidden">
            <div className="flex items-center justify-between border-b border-slate-100 p-8 pt-10">
              <div className="space-y-1 text-right">
                <h2 className="text-2xl font-black text-slate-800">⚡ آخر النشاطات</h2>
                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">تحديثات مباشرة من المجتمع</p>
              </div>
            ...
            <div className="divide-y divide-slate-100 p-8 pt-4">
              {activities.length > 0 ? activities.map((activity, i) => (
                <motion.div 
                  ...
                  className="flex items-center gap-6 py-6 transition-all hover:bg-slate-50/50 group rounded-2xl px-4 -mx-4 cursor-default text-right"
                >
                ...
                <div className="p-12 text-center text-slate-400 font-bold">لا يوجد نشاطات مؤخراً. كن أول من يضيف بصمة خير!</div>
              )}
            </div>
          </div>
        </section>
        ...
        <div className="space-y-8">
          ...
          <section className="glass-card border-none bg-gradient-to-br from-red-600 to-red-800 p-8 text-white shadow-red-200/50">
            <div className="flex items-center gap-4 mb-6 text-right">
              ...
              <div>
                <h2 className="text-xl font-black">طلبات عاجلة</h2>
                <p className="text-xs font-bold text-white/60 leading-none">ساعد الآن وأنقذ حياة</p>
              </div>
            </div>
            <div className="space-y-4">
              <div className="rounded-2xl bg-white/10 p-4 border border-white/10 text-right">
                ...
                <div className="flex justify-between items-end">
                  <span className="text-[10px] font-black uppercase tracking-widest text-white/50">82 طلب — 12 متاح</span>
                  <span className="text-xs font-black text-red-200">شحيح جداً</span>
                </div>
              ...
              <div className="rounded-2xl bg-white/10 p-4 border border-white/10 text-right">
                ...
                <div className="flex justify-between items-end">
                  <span className="text-[10px] font-black uppercase tracking-widest text-white/50">48 طلب — 41 متاح</span>
                  <span className="text-xs font-black text-amber-200">متوفر جزئياً</span>
                </div>
                <div className="mt-3 h-1.5 w-full rounded-full bg-white/10 overflow-hidden">
                  <motion.div 
                    initial={{ width: 0 }}
            ...
            <Link to="/emergency" className="mt-8 flex w-full items-center justify-center gap-2 rounded-2xl bg-white/10 py-4 text-xs font-black uppercase tracking-[0.2em] transition-all hover:bg-white/20">
              تفاصيل الاستغاثات <ArrowRight size={16} className="rotate-180" />
            </Link>
          </section>

          {/* Social Proof / Impact */}
          <section className="glass-card p-8 bg-primary-50/50 border-primary-200 text-right">
            ...
            <div className="text-center py-4 divide-y divide-primary-100">
               <div className="pb-6">
                  ...
                  <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">مريض حصل على دوائه بسببك</p>
               </div>
               <div className="pt-6">
                  <p className="text-2xl font-display font-black text-slate-700">0 ج.م</p>
                  <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-1">وفرت في تكاليف العلاج</p>
               </div>
            </div>
          </section>
        </div>
